...
pub fn spawn_websocat(wsport: usize, tcpport: usize) -> anyhow::Result<(Child)> {
    // TODO: need to install websocat in the PATH, but it was installed in the user
    // dir. Maybe we should search in both places?
    //let program = "websocat";
    let program = "/home/ubuntu/.cargo/bin/websocat";
